...
export default function MileageCalculator() {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-screen bg-zinc-50 dark:bg-[#0a0a0a]">
      <header className="sticky top-0 z-10 backdrop-blur-xl bg-white/70 dark:bg-[#0a0a0a]/70 border-b border-zinc-200/60 dark:border-zinc-800/60">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={toggleLang}
              className="px-2 h-8 rounded-lg flex items-center justify-center border border-zinc-200 dark:border-zinc-700 text-xs font-semibold text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all duration-200"
            >
